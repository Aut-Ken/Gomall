...
('iPhone 15', '苹果iPhone 15，A16仿生芯片', 5999.00, 150, '手机', 'https://example.com/iphone15_std.jpg', 1),
...
('WELCOME100', '新人100元券', 1, 100.00, 500.00, 100.00, 10000, 0, NOW(), DATE_ADD(NOW(), INTERVAL 90 DAY), 1),
('SAVE50', '满1000减50', 1, 50.00, 1000.00, 50.00, 20000, 0, NOW(), DATE_ADD(NOW(), INTERVAL 60 DAY), 1),
('SAVE20', '满500减20', 1, 20.00, 500.00, 20.00, 30000, 0, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), 1);
...
(1, '张三', '13800138000', '北京市', '北京市', '朝阳区', '建国路100号中央商务区C座1201', 1),
(2, '李四', '13900139000', '上海市', '上海市', '浦东新区', '陆家嘴环路1000号金融大厦3502', 1);

-- ============================================
-- 插入订单数据
-- ============================================
INSERT INTO orders (order_no, user_id, product_id, product_name, quantity, total_price, status, pay_type) VALUES
('ORD202401010001', 1, 1, 'iPhone 15 Pro', 1, 8999.00, 4, 1),
('ORD202401010002', 2, 3, 'MacBook Pro 14', 1, 14999.00, 4, 2),
('ORD202401010003', 3, 5, 'AirPods Pro 2', 2, 3798.00, 4, 1),
('ORD202401010004', 1, 7, 'iPad Air', 1, 4799.00, 4, 3);
...
(3, 2, 2, 5, 'MacBook Pro M3性能强劲，续航超赞，办公利器！'),
(5, 3, 3, 5, 'AirPods Pro 2降噪效果太好了，通透模式也很自然。');
...
-- 用户名: admin
-- 密码: 123456
UPDATE users SET password = '$2a$10$aKBeAkAydW2EQenlXAb3EugcChMHhwv7UJr9.zzXSCHj/6BiKLymq' WHERE username = 'admin';