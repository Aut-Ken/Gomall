...
VALUES
    ...
    (
        ...
        200,
        '手机',
        'http://localhost:8080/photos/product_Xiaomi_14_Pro.png',
        1
    ),
    (
        'OPPO Find X7',
    ...
    (
        'ThinkPad X1 Carbon',
        '联想ThinkPad X1 Carbon商务本',
        9999.00,
        50,
        '电脑',
        'https://example.com/x1carbon.jpg',
        1
    ),
    (
        'HP Spectre x360',
    ...
    (
        ...
        200,
        '耳机',
        'https://example.com/freepro3.jpg',
        1
    ),
    -- 平板类
    (
    ...
    (
        'iPad mini 7',
        'Apple iPad mini 7.9英寸',
        3999.00,
        90,
        '平板',
        'https://example.com/ipadmini.jpg',
        1
    ),
    (
        'Samsung Tab S9',
    ...
    (
        ...
        100,
        '平板',
        'https://example.com/xiaomipad.jpg',
        1
    ),
    -- 手表类
    (
    ...
    (
        'Apple Watch Ultra 2',
        'Apple Watch Ultra 2极限版',
        6499.00,
        40,
        '手表',
        'https://example.com/watchultra.jpg',
        1
    ),
    (
        'Samsung Watch 6',
    ...
    (
        ...
        500,
        '智能家居',
        'https://example.com/smarthub.jpg',
        1
    ),
    (
        'Philips Hue Starter',
    ...
    (
        ...
        300,
        '智能家居',
        'https://example.com/smartlock.jpg',
        1
    ),
    (
        'Ecovacs Deebot X2',
    ...
    (
        ...
        40,
        '游戏',
        'https://example.com/steamdeck.jpg',
        1
    ),
    (
        'Xbox Series X',
    ...
    (
        ...
        500,
        '配件',
        'https://example.com/powerbank.jpg',
        1
    ),
    (
        'Apple USB-C Cable',
    ...
    (
        ...
        200,
        '配件',
        'https://example.com/mxmaster.jpg',
        1
    ),
    (
        'Keychron K2',
...
VALUES (
    ...
    (
        ...
        13,
        5,
        'Apple Watch Series 9功能丰富，健康监测很实用。'
    ),
    (
        26,
        1,
